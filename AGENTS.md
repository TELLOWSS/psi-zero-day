...
- Phase D visual 판정은 `docs/PHASE-D-VISUAL-QUALITY-REBASELINE.md`를 따른다. **BINARY LOCKED ≠ VISUAL PRODUCTION LOCKED**이며, 큰 빈 검정 무대·패널 우선 화면·현장 맥락이 사라진 합성은 최종으로 인정하지 않는다. 현재 first wave는 **TBM → FIELD**다.
