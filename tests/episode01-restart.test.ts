...
describe('Episode 01 stop-work restart chain', () => {
  it('turns an unchecked verbal restart into a second stop', () => {
  ...
  it('finds the condition lost while a restart instruction was relayed', () => {
    ...
    expect(getRelation(state.relations, 'kang_taesik', 'player')!.reporting).toBe(33);
  });

  it('keeps work stopped until the physical controls and restart conditions are verified', () => {
