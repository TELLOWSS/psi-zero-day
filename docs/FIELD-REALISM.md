...
- Coordination conflict: construction/safety/subcontract crews wanting incompatible priorities.
- Inspection pressure: supervisor/inspector remarks, reinspection, temporary-action rejection.
...
- Changed instructions may be real, but late or incomplete delivery can also be real.
