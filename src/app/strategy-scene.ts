...
export type StrategySceneLayer = 'background' | 'characters' | 'signals' | 'pressures' | 'dialogue';
 ...
 * the UI how to compose reusable background, character, signal, pressure and dialogue layers.
 */
